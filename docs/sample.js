(function (exports) {
  ...
  (function (PreviewMode) {
      PreviewMode[PreviewMode["Image"] = 0] = "Image";
      PreviewMode[PreviewMode["InstagramStory"] = 1] = "InstagramStory";
  ...
  class ImageStoryPreview {
      constructor(options, _onShowStorySlide) {
          this.options = options;
          this._onShowStorySlide = _onShowStorySlide;
          this._element = null;
  ...
  var NavigationAreaType;
  (function (NavigationAreaType) {
      NavigationAreaType[NavigationAreaType["Prev"] = 0] = "Prev";
      NavigationAreaType[NavigationAreaType["Next"] = 1] = "Next";
  })(NavigationAreaType || (NavigationAreaType = {}));
  ...
  class StoryProgressBarHtmlHelper {
      static getStoryProgressItemChild() {
  ...
  class StoryProgressItem {
      constructor(_width) {
          this._width = _width;
          this._element = null;
          this._progressViewer = null;
      }
      get element() {
          if (this._element === null) {
              this._element = StoryProgressBarHtmlHelper.getStoryProgressItem(this._width);
      ...
      start() {
          this._progressViewer.classList.remove("story-progress-bar__progress-viewer_paused");
          this._progressViewer.classList.remove("story-progress-bar__progress-viewer_new");
          this._progressViewer.classList.add("story-progress-bar__progress-viewer_now");
      }
      finish() {
          this._progressViewer.classList.remove("story-progress-bar__progress-viewer_now");
      }
      setInitialState() {
          this.reset();
      }
      reset() {
          this._progressViewer.setAttribute("class", "story-progress-bar__progress-viewer story-progress-bar__progress-viewer_new");
      }
      suspend() {
          this._progressViewer.classList.add("story-progress-bar__progress-viewer_paused");
      }
      resume() {
          this._progressViewer.classList.remove("story-progress-bar__progress-viewer_paused");
      }
  ...
  class StoryProgressBar {
      ...
      updateVisibleProgresBarItem(index) {
          var _a;
          ...
          (_a = this._activeStoryItem) === null || _a === void 0 ? void 0 : _a.finish();
      ...
      stopProgress() {
          var _a;
          (_a = this._timer) === null || _a === void 0 ? void 0 : _a.destroy();
      }
      destroy() {
          this.stopProgress();
      }
      suspend() {
          ...
          (_a = this._timer) === null || _a === void 0 ? void 0 : _a.pause();
      }
      resume() {
          var _a;
          this._activeStoryItem.resume();
          (_a = this._timer) === null || _a === void 0 ? void 0 : _a.resume();
      }
  }

  class StoryViewHtmlHelper {
      static getPrevImageButtonElement() {
      ...
      static getNextImageButtonElement() {
          const button = document.createElement("div");
          button.classList.add("story-view__navigate-story-button");
  ...
  class StoryView {
      constructor(_options) {
          this._options = _options;
          this._element = null;
          this._mapImages = new Map();
          this._prevAreaElement = StoryViewHtmlHelper.getNavigationArea(NavigationAreaType.Prev);
          this._nextAreaElement = StoryViewHtmlHelper.getNavigationArea(NavigationAreaType.Next);
          this._visibleImageIndex = 0;
          this._overlapElement = StoryViewHtmlHelper.getOverlapElement();
          this._storyContentElement = StoryViewHtmlHelper.getStoryContentElement();
          this._showPrevImageButtonElement = StoryViewHtmlHelper.getPrevImageButtonElement();
          this._showNextImageButtonElement = StoryViewHtmlHelper.getNextImageButtonElement();
          ...
          this._showNextImageButtonElement.addEventListener("click", this.showNextImage);
          this._showPrevImageButtonElement.addEventListener("click", this.showPrevImage);
      ...
      updateNavigationButtonsState() {
          this._showPrevImageButtonElement.classList.remove("story-view__navigate-story-button_disabled");
          this._showNextImageButtonElement.classList.remove("story-view__navigate-story-button_disabled");
          if (this._options.isLastStory === true &&
              this._visibleImageIndex + 1 >= this.storyItemsCount) {
              this._showNextImageButtonElement.classList.add("story-view__navigate-story-button_disabled");
          }
          if (this._options.isFirstStory === true && this._visibleImageIndex === 0) {
              this._showPrevImageButtonElement.classList.add("story-view__navigate-story-button_disabled");
          }
      }
      ...
      getImageElementFromMapByIndex(index) {
      ...
      showNextImage() {
          ...
          this.getImageElementFromMapByIndex(this._visibleImageIndex).classList.add("story-view__image_hidden");
          this._visibleImageIndex += 1;
          this.getImageElementFromMapByIndex(this._visibleImageIndex).classList.remove("story-view__image_hidden");
          this.updateNavigationButtonsState();
          this.updateProgressBar();
      }
      showPrevImage() {
      ...
      destroy() {
          ...
          this._showNextImageButtonElement.removeEventListener("click", this.showNextImage);
          this._showPrevImageButtonElement.removeEventListener("click", this.showPrevImage);
  ...
  class StoriesViewer {
      constructor(_container, _generalOptions) {
          this._container = _container;
          this._generalOptions = _generalOptions;
          this._visibleStoryIndex = 0;
      ...
      setVisibleStoryIndex(storySlide) {
          const userStory = this._stories.find((p) => p.storyOptions === storySlide.options);
      ...
      getStoryView(storyOptions, index) {
      ...
      updateViewportPosition() {
          const offset = 203.125 + this._stories[this._visibleStoryIndex].element.offsetLeft;
          this._storiesContainerElement.setAttribute("style", `right: calc(-50% + ${offset}px);`);
      }
      destroy() {
  ...
  class MobileStoryView extends StoryView {
      constructor(options) {
          super(options);
  ...
  class MobileStoriesViewer extends StoriesViewer {
      show(storySlide) {
      ...
      showStory(activeIndex, previousIndex) {
  ...
  class LightWebStories {
      ...
      initialize() {
          ...
          const swiperContainer = LightWebStories.getBaseLayout(this._options.previewMode, this.getStorySlideElements());
      ...
      addNavigationButtons(swiperContainer) {
      ...
      static getBaseLayout(previewMode, cards) {
      ...
      getStorySlideElements() {
          const result = [];
          for (const item of this._options.items) {
              let storySlideInstance;
              if (this._options.previewMode === PreviewMode.Image) {
                  storySlideInstance = new ImageStoryPreview(item, this.onShowStorySlide.bind(this));
              }
              if (this._options.previewMode === PreviewMode.InstagramStory) {
                  storySlideInstance = new InstagramStoryPreview(item, this.onShowStorySlide.bind(this));
              }
              result.push(storySlideInstance.element);
          }
          return result;
      }
      onShowStorySlide(storySlide) {
          this._storiesViewer.show(storySlide);
      }
  }
  LightWebStories._staticInited = false;
  ...
  function generateStories(groupCount, mode) {
      var result = [];
      for (var groupIndex = 0; groupIndex < groupCount; groupIndex++) {
          var newItem = {
              slideImage: mode === PreviewMode.Image
                  ? getNextImagePreview()
                  : getNextInstaPreview(),
              stories: []
          };
          for (var contentIndex = 0; contentIndex < getRandom(15, 3); contentIndex++) {
  ...
  var App = /** @class */ (function () {
      ...
      App.prototype.setup = function () {
          ...
          var storiesSdk1 = new LightWebStories(options1);
          ...
          var storiesSdk2 = new LightWebStories(options2);
